...
"""Config options available for the Packet service."""
...
class PacketOptions(conf_base.Options):
    ...
    def __init__(self, config):
        ...
        self._options = [
            cfg.StrOpt(
                'metadata_url', default="https://metadata.packet.net/",
            ...
            cfg.StrOpt(
                'local_certificate', default=None,
                help="Local certificate required for the current metadata service."),
        ]
